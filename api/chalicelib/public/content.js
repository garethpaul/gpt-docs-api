...
if (typeof chrome !== "undefined") {
  if (chrome.runtime) {
    newLogoNavImg = chrome.runtime.getURL("gpt-docs-nav.svg");
  } else {
    newLogoNavImg = "gpt-docs-nav.svg";
  }
} else {
  newLogoNavImg = "gpt-docs-nav.svg";
}
...
function createLoader(parentElement) {
  ...
  // Rotate the text of the h2 element every 5 seconds
...
// Build the new list item without parsing markup.
